#!/usr/bin/env python3
"""Verify Qwen behavior on the fresh, pair-disjoint Phase 6 carry corpus."""
...
def main() -> None:
    ...
    report = {
        ...
        "dataset_config_sha256": hashlib.sha256(dataset_path.read_bytes()).hexdigest(),
        "assistant_prefix": dataset_config["assistant_prefix"],
        ...
        "rows": rows,
        "claim_boundary": (
            "Behavior and token-alignment gate on a fresh pair-disjoint corpus. "
